      ...
      >
        <div className="flex flex-col justify-evenly items-center h-full px-20 ">
          ...
          <p className="text-slate-200 text-base leading-7">
            ...
            essential to ensure the security of your account and customize content according to your preferences. By
            accepting our privacy policy and the use of cookies, you enable full access to the features of our
            application. Click <span className="font-semibold text-violet-300">"Accept"</span> to continue using our
            website.
          </p>
        </div>
      </Portal>
