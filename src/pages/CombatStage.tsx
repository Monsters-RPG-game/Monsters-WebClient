...
//               <img
//                 src={images.RacesImage2}
//                 className="w-[110px] sm:w-[155px] md:w-[140px] lg:h-[350px]  lg:w-auto xl:h-[365px] xl:w-auto"
//                 alt=""
//               />
//             </div>
//             <div className="flex flex-col  flex-1 gap-[1px]">
//               <span className=" mx-auto bg-green-600 text-slate-50 font-semibold text-md px-8 rounded-md">
//                 29/100 <span className="text-xs text-rose-300 ">HP</span>
//               </span>
//               <span className="mx-auto bg-blue-600 text-slate-100 font-semibold text-md px-8 rounded-lg">
//                 {' '}
//                 90/100 <span className="text-xs text-blue-100">MP</span>
//               </span>
//             </div>
//           </div>
...
//         <button onClick={() => attack(enemy)} className="bg-emerald-700 rounded-lg font-semibold text-slate-50 p-2">
//           Attack
//         </button>
//         <button className="bg-emerald-700 rounded-lg font-semibold text-slate-50 p-2">Attack</button>
//         <button className="bg-emerald-700 rounded-lg font-semibold text-slate-50 p-2">Attack</button>
//         <button className="bg-emerald-700 rounded-lg font-semibold text-slate-50 p-2">Attack</button>
//         <button onClick={fightModalHandler} className="bg-rose-700 text-sm text-white px-2 rounded-md font-semibold">
//           Leave Fight
//         </button>
//       </div>
//     </div>
